...
def _normalize_mysql_cell(value):
    """mysql-connector devolve Decimal em agregações; o AgGrid exibe isso como [object Object]."""
...
def get_dataframe_from_query(consulta, use_grupoe=False, use_blueme=False):
    ...
    return df.map(_normalize_mysql_cell)
